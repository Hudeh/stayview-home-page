        ...
        <div className="grid gap-14 lg:grid-cols-[1fr_1.15fr] lg:gap-20">
          <Reveal variant="left" stagger>
            ...
            <AnimatedHeadline
              ...
              lines={["Cloud for speed.", "On-prem for control."]}
            />
            <p className="stagger-item mt-6 text-lg leading-relaxed text-muted">
          ...
          <div className="space-y-0 divide-y divide-border border-y border-border">
            {whyStayViewPoints.map((point, i) => (
              <Reveal key={point.title} delayMs={i * 80} as="article" variant="right">
                <div className="grid gap-4 py-8 sm:grid-cols-[3rem_1fr] sm:gap-6">
                  <span className="chapter-mark font-display text-2xl font-bold text-brand/30">
